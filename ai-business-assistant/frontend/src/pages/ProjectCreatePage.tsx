...
export default function ProjectCreatePage() {
  ...
  return <Layout back><div className="mx-auto max-w-3xl rounded-3xl bg-white p-6 shadow-sm"><h1 className="text-2xl font-bold">新增工作</h1><p className="mt-2 text-sm leading-6 text-slate-500">你可以把一个业务问题、一个任务、一套流程或一个想法创建成一项工作，后续持续补充资料并让 AI 生成方案。</p><form onSubmit={submit} className="mt-6 space-y-5">
    <input className="w-full rounded-xl border p-3" placeholder="工作名称" value={title} onChange={e => setTitle(e.target.value)} />
