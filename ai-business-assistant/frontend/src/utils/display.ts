...
export const projectTypeLabels: Record<string, string> = {
  general: '通用业务工作', unknown: '待 AI 判断', software: '软件开发', software_development: '软件开发', automation: '自动化流程', office_automation: '办公自动化', data_analysis: '数据分析', consulting: '咨询方案', business_consulting: '业务咨询',
};
...
export const reportLabels: Record<string, { title: string; description: string }> = {
  comprehensive_analysis: { title: '工作综合分析报告', description: '汇总工作目标、资料发现、执行建议和关键风险。' },
  ...
  risk_report: { title: '风险分析报告', description: '识别工作风险并提供应对建议。' },
