...
export interface Employee { id:number; user_id:number; name:string; avatar:string; department:string; position:string; role_prompt:string; industry:string; reply_mode:'text'|'voice'; can_create_project:boolean; can_delete_project:boolean; can_view_project_data:boolean; can_view_project_reports:boolean; can_view_other_employee_messages:boolean; can_view_project_progress:boolean; created_at:string; updated_at:string }
