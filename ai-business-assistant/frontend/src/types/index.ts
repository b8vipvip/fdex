...
export interface Employee { id:number; user_id:number; name:string; avatar:string; avatar_url?:string; job_role_id?:number; is_system?:boolean; is_material_manager?:boolean; allow_upload_assets?:boolean; allow_receive_project_context?:boolean; department:string; position:string; role_prompt:string; industry:string; reply_mode:'text'|'voice'; can_create_project:boolean; can_delete_project:boolean; can_view_project_data:boolean; can_view_project_reports:boolean; can_view_other_employee_messages:boolean; can_view_project_progress:boolean; is_active:boolean; resigned_at?:string|null; created_at:string; updated_at:string }
