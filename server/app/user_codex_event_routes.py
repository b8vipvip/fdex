...
# This module is imported in every Web worker. Registering the MCP method/projection here makes an
# answered event generated by a different worker identical to the pending event generated by the
# worker that owns the Codex stdio Host.
install_mcp_elicitation_compat()
